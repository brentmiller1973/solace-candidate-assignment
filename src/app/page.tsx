  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-hero min-h-screen">
        ...
        <section ref={searchSectionRef} className="bg-neutral-white/90 backdrop-blur-sm rounded-2xl border-2 border-accent-gold-light p-8 mb-12 shadow-card">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-heading text-2xl md:text-3xl font-normal">
              Available Advocates
            </h2>
            <div className="text-neutral-dark-grey">
              <span className="font-medium text-primary-default">{filteredAdvocates.length}</span> of {advocates.length} advocates
            </div>
          </div>
