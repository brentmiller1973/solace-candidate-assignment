    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-neutral-grey text-sm">
          font-heading, text-4xl, font-bold, text-primary
        </p>
      </div>
    ...
    <div className="space-y-6 max-w-2xl">
      <div>
        <p className="font-body text-base text-neutral-black leading-relaxed mb-2">
          This is a regular paragraph using the body font family. It demonstrates the default text styling 
          used throughout the application. The text uses Inter font family with proper line height for 
          optimal readability.
        </p>
        <p className="text-neutral-grey text-sm">
      ...
      <div>
        <p className="font-body text-base text-neutral-black leading-relaxed mb-2">
          ...
          <a href="#" className="text-primary hover:text-accent-gold underline transition-colors">
            Links
          </a> are styled with primary color and gold hover state.
        </p>
        <p className="text-neutral-grey text-sm">
