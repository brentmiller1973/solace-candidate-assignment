...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      'text-neutral-black bg-accent-gold bg-gradient-primary hover:bg-gradient-primary-hover hover:translate-y-[-4px] shadow-primary hover:shadow-primary-hover',
    secondary:
      'text-neutral-black bg-neutral-white border border-neutral-grey hover:bg-neutral-grey hover:text-neutral-black transition-colors duration-300',
